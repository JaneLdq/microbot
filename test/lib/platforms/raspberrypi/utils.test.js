/**
 *utils for raspberrypi test
 */
const Utils = lib('platforms/raspberrypi/utils');

describe("raspUtils",() =>{
	
	describe("periodAndDuty",() =>{
		const fn =Utils.periodAndDuty;
		
		it("calculates values for PWM", () =>{
			const value = fn(0.5,2000,null,null);
