...
var ContinuousServo = lib("drivers/gpio/continuous-servo");
...
describe("ContinuousServo", function() {
  ...
  describe("#stop", function() {
    it("writes a scaledValue of 0.5 (90 non scaled) to the servo", function() {
      ...
      expect(driver.connection.servoWrite.calledWith(13, 0.5, null, {
          min: 500,
          max: 2400
        }, callback))
        .to.be.called;
  ...
  describe("#rotate", function() {
    it("writes a scaled value of 1 when rotation is clockwise", function() {
      ...
      expect(driver.connection.servoWrite.calledWith(13, 1, null, {
        min: 500,
        max: 2400
      })).to.be.called;
    });
    ...
    it("writes a scaled value of 0.49 when counter-clockwise", function() {
      ...
      expect(driver.connection.servoWrite.calledWith(13, 0, null, {
        min: 500,
        max: 2400
      })).to.be.called;
    });
  ...
  describe("#counterClockwise", function() {
    it("writes a scaled value of 0.49 to the servo", function() {
      ...
      expect(driver.connection.servoWrite.calledWith(
        13,
        0,
        null, {
          min: 500,
