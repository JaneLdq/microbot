...
let Service = module.exports = class Service extends EventEmitter {
	...
	constructor(opts) {
		...
		let req = './' + this.protocol + '-server';
		let Server = require(req);
...
/**
 * [Private] Initialize a httq server to listening mqtt published messages
