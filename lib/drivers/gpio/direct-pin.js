...
const DirectPin = module.exports = class DirectPin extends Driver {
   ...
   * @publish
   */
  digitalWrite = function(value, callback) {
   ...
   * @publish
   */
  analogWrite = function(value, callback) {
   ...
   * @publish
   */
  analogRead = function(callback) {
    this._read("a", callback);
  }

  _read = function(type, callback) {
    if (!this.readSet) {
      switch (type) {
        case "a":
   ...
   * @publish
   */
  servoWrite = function(angle, callback) {
   ...
   * @publish
   */
  pwmWrite = function(value, callback) {
